          ...
          <div className="singlecontent">
            <div className="hover_8_wrap">
              <h2 className="tech_title fade_bottom_4" ref={hoverWrap}>
                DESIGN AND <Link href="/about">Technology</Link> PLAYGROUND
                TRANSFORMING YOUR <Link href="/about">IDEAS</Link>
                INTO REALITY
              </h2>
              <div
                className="hover_8_img"
                style={{
                  backgroundImage: "url(assets/imgs/portfolio/detail/8.jpg)",
                }}
                ref={hoverImage}
              ></div>
              <div
            ...
            <p className="single_dis pb-110 fade_bottom_4">
              we believe in empowering businesses to thrive in the digital
              landscape. With our expertise in digital marketing and web
              development,<br/> we bring your brand's vision to life and ensure it
              reaches the right audience, at the right time, on the right
              platforms. <br />
            </p>
            <div className="single__thumb">
              <video loop muted autoPlay playsInline>
                <source src="assets/video/video-new.mp4" type="video/mp4" />
              </video>
              <Image
                priority
